...
이 문서는 일상적인 기여 흐름을 위한 안내입니다. 어떻게 변경을 만들고, 무엇을 검증하고, 어떤 문서를 같이 맞춰야 하는지 한 번에 볼 수 있게 정리했습니다.
...
처음 기여한다면 문서 수정, 작은 버그 수정, 또는 `good first issue` 라벨이 붙은 이슈부터 시작하는 편이 좋습니다.
