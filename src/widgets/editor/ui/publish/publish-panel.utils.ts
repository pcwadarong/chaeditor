...
/**
 * Checks whether comment controls should be shown for the current content type.
 */
export const shouldShowPublishCommentsSetting = (contentType: EditorContentType) =>
  contentType === 'article';

/**
 * Creates the default publish settings used by draft save and publish initialization.
 */
...
/**
 * Converts local schedule input values into a UTC ISO string.
 */
...
/**
 * Normalizes publish panel form values into the final payload shape.
 */
...
/**
 * Validates required fields and schedule timing before publish.
 */
