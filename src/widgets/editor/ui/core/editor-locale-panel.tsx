...
/**
 * Renders the localized editor panel and preview panel.
 */
    ...
    <div className={summaryGridClass}>
      ...
      <div className={summaryFieldClass}>
        ...
        <Textarea
          ...
          placeholder={`${localeLabel} description`}
        ...
        <div className={previewStackClass}>
          ...
          >
            {shouldRenderPreview && translation.content.trim().length > 0 ? (
              ...
              <p className={emptyPreviewClass}>Nothing to preview yet.</p>
            )}
          </section>
        </div>
      </div>
