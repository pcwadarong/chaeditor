...
export const LinkEmbedPopover = ({
  ...
  const resolvedLabels: LinkEmbedPopoverLabels = {
    ...
    panelLabel: labels?.panelLabel ?? 'Insert link',
    previewButtonLabel: labels?.previewButtonLabel ?? 'Preview link',
    triggerAriaLabel: labels?.triggerAriaLabel ?? 'Insert link',
    triggerTooltip: labels?.triggerTooltip ?? 'Insert link',
    urlInputAriaLabel: labels?.urlInputAriaLabel ?? 'Link URL',
    urlPlaceholder: labels?.urlPlaceholder ?? 'https://example.com',
    hyperlinkButtonLabel: labels?.hyperlinkButtonLabel ?? 'Hyperlink',
  };
