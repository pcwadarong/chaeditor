...
describe('LinkEmbedCard', () => {
  ...
  it('Under a pending host fetcher, LinkEmbedCard must render the loading skeleton', () => {
    ...
    expect(screen.getByText('Loading link information...')).toBeInTheDocument();
  });
  ...
  it('Under insufficient preview metadata, LinkEmbedCard must fall back to a regular external link', async () => {
    render(
      <LinkEmbedCard
    ...
    expect(screen.queryByText('Loading link information...')).not.toBeInTheDocument();
  });

  it('Under a failing host fetcher, LinkEmbedCard must fall back to a regular external link', async () => {
    render(
      <LinkEmbedCard
