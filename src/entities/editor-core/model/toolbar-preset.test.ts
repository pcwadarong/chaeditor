...
describe('markdown toolbar preset', () => {
  it('Under the default preset, resolveMarkdownToolbarPresetSections must preserve the fixed section and item order', () => {
    expect(
      resolveMarkdownToolbarPresetSections({
        itemRegistry: {
  ...
  it('Under a partial custom preset, resolveMarkdownToolbarPresetSections must combine only the requested item keys', () => {
    expect(
      resolveMarkdownToolbarPresetSections({
        itemRegistry: {
          bold: 'bold',
